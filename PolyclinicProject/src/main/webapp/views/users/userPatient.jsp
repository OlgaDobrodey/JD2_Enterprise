                    ...
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <div class="mt-3">
                                ...
                                <h4>${sessionScope.user.surname} ${sessionScope.user.given_name}
                                </h4>
                                <p class="text-secondary mb-1">${sessionScope.user.role}</p>
                                <p class="text-secondary mb-1">Medical cart number</p>
                                <p class="text-secondary mb-1">${sessionScope.user.madical_card}</p>

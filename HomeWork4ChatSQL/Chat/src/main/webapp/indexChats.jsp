...
<%--<%--%>
<%--//    Connection connection = DaoFactory.getInstance(DatabaseName.POSTGRES).getConnectionBase();--%>
...
<%
    ...
    out.write(print);
%>
<%--<c:out value="${printMSG}"/>--%>

<%--<c:out value="${(new DataMessage()).printMessasgeUserLoginC(userSender)}"/>--%>
